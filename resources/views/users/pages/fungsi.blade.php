        ...
        <div class="card my-4 py-3 px-3 px-md-5">
          <div class="card-body">
            <div class="d-flex flex-column flex-md-row justify-content-center align-items-center">
              <a href="furniture.html" class="bg-color-primary text-uppercase text-decoration-none fw-bold text-center text-white py-2 px-4 rounded-pill fs-5 flex-fill me-0 me-md-4">sebelumnya</a>
              ...
              <a href="usia.html" class="bg-color-primary text-uppercase text-decoration-none fw-bold text-center text-white py-2 px-4 rounded-pill fs-5 flex-fill ms-0 ms-md-4 mt-3 mt-md-0">selanjutnya</a>
            </div>
            ...
            <div name="furnitures" class="row">
              <div class="col-12 col-md-4">
                <a href="usia.html" class="bg-image hover-overlay">
